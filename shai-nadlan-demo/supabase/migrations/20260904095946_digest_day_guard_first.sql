-- The day guard runs BEFORE the hour guard. Two reasons: it is the cheaper
-- check, and with the hour guard first the day guard is unobservable from a
-- test call at any other time of day — a guard nothing can exercise is a
